...
class BlogPostDAO:
    ...
    def insert_entry(self, title, post, tags_array, author):
        ...
        # now insert the post
        try:
            result=self.posts.insert_one(post) #XXXX Ankit
    ...
    def get_posts(self, num_posts):
        ...
        cursor=self.posts.find(query).sort('date',-1).limit(num_posts)  #Ankit code
    ...
    def get_post_by_permalink(self, permalink):
        ...
        post = None
        # XXXX 3.2 Work here to retrieve the specified post
    ...
    def add_comment(self, permalink, name, email, body):
        ...
        try:
            ...
            query={'permalink':permalink}
            result=self.posts.update_one(query,{'$push':{'comments':comment}})
